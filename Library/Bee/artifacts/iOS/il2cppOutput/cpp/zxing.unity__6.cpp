...
IL_0013:
	...
	}
	{
		...
		NullCheck(L_4);
		bool L_5;
		L_5 = InterfaceFuncInvoker1< bool, int32_t >::Invoke(2, IDictionary_2_t96BBC4E7273214BD35166293657C54EBFB060DF7_il2cpp_TypeInfo_var, L_4, 1);
		if (!L_5)
		{
			goto IL_0052;
		}
...
IL_007c:
	...
	}
	{
		...
		NullCheck(L_28);
		bool L_29;
		L_29 = InterfaceFuncInvoker1< bool, int32_t >::Invoke(2, IDictionary_2_t8BD3FBFB61AB580CC7009E3B888C03B9F7BAB843_il2cpp_TypeInfo_var, L_28, 3);
		if (!L_29)
		{
			goto IL_00aa;
		}
...
IL_00b4:
	{
		...
		NullCheck(L_34);
		bool L_35;
		L_35 = InterfaceFuncInvoker1< bool, int32_t >::Invoke(2, IDictionary_2_t8BD3FBFB61AB580CC7009E3B888C03B9F7BAB843_il2cpp_TypeInfo_var, L_34, 5);
		if (!L_35)
		{
			goto IL_00d8;
		}
