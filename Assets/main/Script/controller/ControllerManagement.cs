...
{
    public class ControllerManagement : FireBaseCommon
    {
        ...
        private void UpdateEvent()
        {
            ...
            FindObjectOfType<TableManagement>().DrawTableFullMon(month,year);
        ...
        {
            find.text = temp.text;
            FindObjectOfType<TableManagement>().DrawTableWithName(month,year,temp.text);
        }
